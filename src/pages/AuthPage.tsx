  ...
  return (
    <div className="min-h-screen bg-base-100 py-8 px-4 sm:px-6 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute -bottom-24 -right-24 w-96 h-96 rounded-full bg-gradient-to-br from-secondary/20 to-primary/10 blur-3xl opacity-50 animate-pulse" style={{ animationDelay: '1s' }}></div>
        
        {/* Partículas brilhantes */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-primary/50 rounded-full blur-sm animate-pulse"></div>
        <div className="absolute top-3/4 left-2/3 w-3 h-3 bg-secondary/50 rounded-full blur-sm animate-pulse" style={{ animationDelay: '0.5s' }}></div>
        <div className="absolute top-1/3 right-1/4 w-2 h-2 bg-primary/50 rounded-full blur-sm animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        <div className="absolute bottom-1/4 left-1/3 w-3 h-3 bg-secondary/50 rounded-full blur-sm animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
                  ...
                  <CardContent>
                    <Form {...loginForm}>
                      <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                              ...
                              <FormControl>
                                <div className="relative group">
                                  ...
                                  <Input 
                                    ...
                                    className="pl-10 ring-offset-background focus-visible:ring-primary/20 transition-all duration-200 border-input/50 focus:border-primary" 
                                    {...field}
                                  />
                                </div>
                              </FormControl>
                        ...
                        <Button 
                          type="submit" 
                          className="w-full h-12 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-white font-medium text-base relative overflow-hidden group shadow-lg shadow-primary/20 animate-gradient-shift" 
                          disabled={loading}
                        >
                        ...
                        <Button 
                          type="button" 
                          variant="outline" 
                          className="w-full h-12 relative group overflow-hidden border-input/50 hover:border-primary/30 shadow-md transition-all duration-300"
                        ...
                        <Button 
                          type="button" 
                          variant="outline" 
                          className="w-full h-12 bg-gradient-to-r from-primary/5 to-secondary/5 hover:from-primary/10 hover:to-secondary/10 border-primary/10 hover:border-primary/20 shadow-md hover:shadow-lg transition-all duration-300 mt-4"
                          onClick={fillTestCredentials}
                        >
                          <span className="relative flex items-center justify-center">
                            <LogIn className="mr-3 h-5 w-5 text-primary/80" />
