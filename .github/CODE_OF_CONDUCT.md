...
Instâncias de comportamento abusivo, de assédio ou de outra forma inaceitável podem ser reportadas aos líderes da comunidade responsáveis pela aplicação em [felixskmarcio@gmail.com](mailto:felixskmarcio@gmail.com). Todas as reclamações serão revisadas e investigadas prontamente e de forma justa.
...
- **GitHub**: [@felixskmarcio](https://github.com/felixskmarcio)

## Atualizações

Este Código de Conduta pode ser atualizado periodicamente. Todas as mudanças significativas serão comunicadas à comunidade através de:

- Anúncio nas [Discussions](https://github.com/felixskmarcio/eisenhower-task-manager/discussions)
- Notificação por email para contribuidores ativos
- Destaque no README do projeto

---

*Última atualização: Janeiro 2024*
*Gerenciado pelo RepoGuardian AI 🤖*